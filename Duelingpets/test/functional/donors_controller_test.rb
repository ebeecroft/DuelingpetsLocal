...
class DonorsControllerTest < ActionController::TestCase
  ...
  test "should create donor" do
    assert_difference('Donor.count') do
      post :create, donor: { amount: @donor.amount, created_on: @donor.created_on, description: @donor.description, donationbox_id: @donor.donationbox_id, user_id: @donor.user_id }
    end
  ...
  test "should update donor" do
    put :update, id: @donor, donor: { amount: @donor.amount, created_on: @donor.created_on, description: @donor.description, donationbox_id: @donor.donationbox_id, user_id: @donor.user_id }
    assert_redirected_to donor_path(assigns(:donor))
  end
