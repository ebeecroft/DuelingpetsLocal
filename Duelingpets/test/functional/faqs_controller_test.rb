...
class FaqsControllerTest < ActionController::TestCase
  ...
  test "should create faq" do
    assert_difference('Faq.count') do
      post :create, faq: { created_on: @faq.created_on, description: @faq.description, mp3: @faq.mp3, ogg: @faq.ogg, title: @faq.title }
    end
  ...
  test "should update faq" do
    put :update, id: @faq, faq: { created_on: @faq.created_on, description: @faq.description, mp3: @faq.mp3, ogg: @faq.ogg, title: @faq.title }
    assert_redirected_to faq_path(assigns(:faq))
  end
