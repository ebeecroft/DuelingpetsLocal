...
class PmsControllerTest < ActionController::TestCase
  ...
  test "should create pm" do
    assert_difference('Pm.count') do
      post :create, pm: { created_on: @pm.created_on, from_user_id: @pm.from_user_id, message: @pm.message, title: @pm.title, user_id: @pm.user_id }
    end
  ...
  test "should update pm" do
    put :update, id: @pm, pm: { created_on: @pm.created_on, from_user_id: @pm.from_user_id, message: @pm.message, title: @pm.title, user_id: @pm.user_id }
    assert_redirected_to pm_path(assigns(:pm))
  end
