...
class SubtopicsControllerTest < ActionController::TestCase
  ...
  test "should create subtopic" do
    assert_difference('Subtopic.count') do
      post :create, subtopic: { created_on: @subtopic.created_on, description: @subtopic.description, maintopic_id: @subtopic.maintopic_id, title: @subtopic.title, topicavatar: @subtopic.topicavatar, user_id: @subtopic.user_id }
    end
  ...
  test "should update subtopic" do
    put :update, id: @subtopic, subtopic: { created_on: @subtopic.created_on, description: @subtopic.description, maintopic_id: @subtopic.maintopic_id, title: @subtopic.title, topicavatar: @subtopic.topicavatar, user_id: @subtopic.user_id }
    assert_redirected_to subtopic_path(assigns(:subtopic))
  end
